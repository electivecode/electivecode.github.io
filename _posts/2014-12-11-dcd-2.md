...
However, if you do `console.log("$O", $0)` like before, we get the *complicated view* of a DOM object.

![](http://cl.ly/image/1t261o1E0p0l/Pasted_Image_12_17_14__7_13_PM.png)

Whatever is displayed on Elements panel is the *simplified view* of a DOM object.
